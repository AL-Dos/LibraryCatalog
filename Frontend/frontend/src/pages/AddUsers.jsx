      ...
      <main className='flex h-screen'>
        ...
        <div className='w-screen'>
          <div className='flex flex-col items-center border-b border-neutral-500 mb-10'>
            <h1 className='main-text my-12'>SUBMIT USER DETAILS</h1>
          </div>
          <div className='flex flex-col'>
            <div className='add'>
              <div className='info'>
                <label className='text'>USERNAME</label>
                <input type='text' placeholder='Enter Username' className='textfield' />
              </div>
              <div className='info'>
                <label className='text'>EMAIL</label>
                <input type='text' placeholder='Enter Email' className='textfield' />
              </div>
              <div className='info'>
                <label className='text'>PASSWORD</label>
                <input type='password' placeholder='Enter Password' className='textfield' />
              </div>
              <div className='info'>
