      ...
      <main className='flex h-screen'>
        ...
        <div className='w-screen'>
          <div className='flex flex-col items-center border-b border-neutral-500 mb-10'>
            <h1 className='main-text my-12'>SUBMIT BOOK DETAILS</h1>
          </div>
          <div className='flex flex-col'>
            <div className='add'>
              <div className='info'>
                <label className='text'>NAME</label>
                <input type='text' placeholder='Enter Book Name' className='textfield' />
              </div>
              <div className='info'>
              ...
              <div className='info'>
                ...
                <input type='text' placeholder='Enter ISBN' className='textfield' />
              </div>
              <div className='info'>
                <label className='text'>AUTHOR</label>
                <input type='text' placeholder='Enter Author Name' className='textfield' />
              </div>
              <div className='info'>
                <label className='text' l>PUBLISHER</label>
                <input type='text' placeholder='Enter Publisher Name' className='textfield' />
              </div>
              <div className='info'>
                <label className='text'>AVAILABILITY</label>
                <select className='textfield'>
