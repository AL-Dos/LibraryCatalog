        ...
        <main className='flex h-screen'>
          ...
          <div className='w-full'>
            <div className='flex flex-col items-center border-b border-neutral-500'>
              <h1 className='main-text my-12 mx-5'>WELCOME TO THE LIBRARY, ADMIN!</h1>
              <h4 className='text-xl text-white font-bold mb-5 text-center mx-5'>"NAVIGATE AND MANAGE LITERARY TREASURES"</h4>
              <button className='hover py-4 px-8 border rounded-lg bg-black/20 text-white font-medium mb-5'>REFRESH PAGE</button>
            </div>
            <div className='flex flex-row items-center py-5 my-5 mx-5 h-2/6 gap-5'>
              <div className='cards'>TOTAL BOOKS<br/>____ ____</div>
              <div className='cards'>AVAILABLE BOOKS<br/>____ ____</div>
              <div className='cards'>ISSUED BOOKS<br/>____ ____</div>
            </div>
            <div className='flex flex-row items-center py-5 my-5 mx-5 h-2/6 gap-5'>
              <div className='cards'>RETURNED BOOKS<br/>____ ____</div>
              <div className='cards'>TOTAL USERS<br/>____ ____</div>
            </div>
          </div>
        </main>
      </div>
