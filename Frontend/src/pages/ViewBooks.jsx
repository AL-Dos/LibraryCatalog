      ...
      <main className='flex h-screen'>
        ...
        <div className='w-screen'>
          <div className='flex flex-col items-center border-b border-neutral-500 mb-10'>
            <h1 className='main-text my-12'>VIEW BOOKS</h1>
          </div>
            ...
            <table className='w-full text-left'>
              <thead>
                <tr>
                  ...
                  <th className='tbody font-extrabold text-xl'>Name</th>
                  <th className='tbody font-extrabold text-xl'>Category</th>
                  <th className='tbody font-extrabold text-xl'>ISBN</th>
                  <th className='tbody font-extrabold text-xl'>Author</th>
                  <th className='tbody font-extrabold text-xl'>Publisher</th>
